...
- **Test environment**
- **Live environment**
> Both uses the same API: `https://api.orafi.app`. To toggle between modes, merchants can visit their dashboard, or use proided endpoint.
...
- Use tools like ngrok or outray for local development
